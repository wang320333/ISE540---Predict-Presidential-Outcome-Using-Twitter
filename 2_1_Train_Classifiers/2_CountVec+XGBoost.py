...
print(accuracy_score(y_test, predictionXGB))
...
#prediction
XGB5W_pred = xgb_classifier.predict(X_cv2)
pred_5w = dfj
pred_5w["Description_num"] = XGB5W_pred 
pred_5w.to_csv(r'Prediction_new5w(XGBoost+CountVec).csv', index = False)
