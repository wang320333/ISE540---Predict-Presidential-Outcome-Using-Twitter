...
predictionKN = neigh.predict(X_test)
...
#prediction
KNN5W_pred = neigh.predict(X_cv2)
pred_5w = dfj
pred_5w["Description_num"] = KNN5W_pred
pred_5w.to_csv(r'Prediction_new5w(KNN+CountVec).csv', index = False)
