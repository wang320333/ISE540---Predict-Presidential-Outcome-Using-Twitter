...
nb_classifier.fit(X_train, y_train) #y_train change to 1 column
predictionNB = nb_classifier.predict(X_test)
print(classification_report(y_test,predictionNB))  
print(accuracy_score(y_test, predictionNB))
...
NB5W_pred = nb_classifier.predict(X_cv2)
pred_5w = dfj
pred_5w["Description_num"] = NB5W_pred
pred_5w.to_csv(r'Prediction_new5w(NaiveBayes+CountVec).csv', index = False)
